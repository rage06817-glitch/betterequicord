 ...
 * @author arg0NNY
 * @version 1.7.0
 * @description Listen or talk in voice while self-deafened. Toggle button styled like native Mute/Deafen.
 * @source https://github.com/arg0NNY/DiscordPlugin-FakeDeafen
 */

module.exports = (_ => {
	const changeLog = { fixed: ["Toggle button now styled like native Mute/Deafen buttons"] };
		...
		return class FakeDeafen extends Plugin {
			...
			injectToggleButton() {
				...
				BDFDB.PatchUtils.after(VoicePanel.prototype, "render", (_, args, res)=>{
					...
					const toggleBtn = BDFDB.React.createElement(BDFDB.LibraryComponents.TooltipContainer, {
						tooltipText: this.fixated ? "Disable FakeDeafen" : "Enable FakeDeafen",
						children: BDFDB.React.createElement("button", {
							key: "fakeDeafenToggle",
							type: "button",
							className: "button-38aScr lookBlank-3b1Be1 colorBrand-3pXr91 sizeMedium-2tS5k6 grow-2sR_-F",
							onClick: ()=>this.toggleFixate(),
							style: { marginLeft:"6px", padding: "8px" }
						}, BDFDB.React.createElement("svg",{width:24,height:24,viewBox:"0 0 20 20"},
